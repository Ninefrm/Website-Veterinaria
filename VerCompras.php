...
//        echo
            ...
            $id_libro = $Sql['id_producto'];
            $libros = $conn -> prepare("
	SELECT * FROM producto WHERE activo = '1' AND id_producto = $id_libro");
//Libro
            $libros ->execute();
...
//            echo $Total = count($libros);
            foreach ($libros as $SqlLibro):
                ...
                ?>
                <tr>
                    <?php $str = strtoupper($SqlLibro['nombre']); echo "<td>". $str ."</td>"; ?>
                    <?php echo "<td>". $SqlLibro['codigo'] ."</td>"; ?>
                    <?php if($tipo=="Administrador"){
